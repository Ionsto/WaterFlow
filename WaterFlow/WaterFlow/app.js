...
var World = (function () {
    ...
    function World() {
        ...
        this.WorldSize = 100;
        this.GridToCanvas = 5;
        this.FlowPerTick = 0.4;
        this.SiltPerTick = 0.1;
                ...
                for (var i = 0; i < AjoiningCellHeights.length; ++i) {
                    ...
                    if (AjoiningCellHeights[i][2] - GroundHeightCurrent < WaterHeightCurrent - TakenFlow && WaterHeightCurrent - TakenFlow > 0) {
                        ...
                        for (var j = i; j < AjoiningCellHeights.length; ++j) {
                            ...
                            //this.VelocityMapX.AddValueAt(x, y, Flow * (AjoiningCellHeights[j][0] - x));
                            //this.VelocityMapY.AddValueAt(x, y, Flow * (AjoiningCellHeights[j][1] - y));
