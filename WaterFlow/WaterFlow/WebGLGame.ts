...
module WebGLGame {
    export class WebGLGame {
        ...
        TextureDataHeight: number;
        TextureDataWidth: number;
        ...
        InitShaderStaggerd() {
            ...
            var Size = this.world.WorldSize;//Math.pow(2, Math.ceil(Math.log(world.WorldSize) / Math.log(2)));
            //alert(Size);
